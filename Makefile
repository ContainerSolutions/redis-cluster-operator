...
# container-solutions.com/redis-operator-bundle:$VERSION and container-solutions.com/redis-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= container-solutions.com/redis-cluster-operator
...
IMG ?= containersol/redis-cluster-operator:latest
